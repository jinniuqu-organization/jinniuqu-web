  ...
  <div class="home">
    ...
    <div class="head">
      ...
      <div class="tit">
        ...
        <div class="tit_box">
          <div class="tit_word">金牛区基础数据库平台</div>
        </div>
      </div>
    ...
    <!-- 内容展示 （选项卡模式）-->
    <div class="content">
      <!-- <GovernanceServices v-if="navIndex==1"></GovernanceServices> -->
      <!-- 旧/治理服务监控 -->
      <ManageServiceMonitor v-if="navIndex==1"></ManageServiceMonitor> <!-- 治理服务监控 -->
      <!-- <HomeMain v-if="navIndex==5"></HomeMain> -->
      <!-- 治理组织架构 -->
      <DataCollection v-if="navIndex==2"></DataCollection><!-- 数据汇集监控 -->
      <!--<DataQuality v-if="navIndex==1"></DataQuality>&lt;!&ndash; 数据质量监控 &ndash;&gt;-->
      <!-- <DataStandardManagement v-if="navIndex==4"></DataStandardManagement> -->
      <!-- 数据标准管理 -->
      <!-- <DataGovernance v-if="navIndex==6"></DataGovernance> -->
      <!-- 数据治理服务 -->
