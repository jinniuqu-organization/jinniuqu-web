  ...
  <div class="quality">
    <div class="top">
      ...
      <div class="top_col">
        ...
        <div style="height: 47%;">
          <div class="geren_logo" style="height: 49%">
            <div class="logo_base">
              <div :class="healthCode !== 0 ? 'logo_jkm_wu' : 'logo_jkm_you'"></div>
              <p class="p_len_4">是否绿码</p>
            </div>
            <div class="logo_base">
              <div :class="personInfo.ifWishVaccine === '否' || !personInfo.hasOwnProperty('ifWishVaccine') ? 'logo_yxjz_wu' : 'logo_yxjz_you'"></div>
              <p class="p_len_6">是否意向接种</p>
            </div>
            <div class="logo_base">
              <div :class="personInfo.ifHaveVaccine === '否' || !personInfo.hasOwnProperty('ifHaveVaccine') ? 'logo_jzym_wu' : 'logo_jzym_you'"></div>
              <p class="p_len_6">是否接种疫苗</p>
            </div>
            <div class="logo_base">
      ...
      <div class="top_col" style="margin-right: -0.26rem;">
        ...
        <div class="detail" style="top: 15rem; z-index: 9">
          ...
          <div class="time_content">
            <div class="time_item">
              <div class="item_date">
                <template v-if="Object.keys(chainInfo).length != 0">
                  <span>{{ chainInfo[3].monthId.split('-')[0] }}年{{ chainInfo[3].monthId.split('-')[1] }}月</span>
                </template>
                <template v-else>
                  <span>-&nbsp;年&nbsp;-&nbsp;月</span>
                </template>
              ...
              <div class="item_content" style="bottom: 8%">
                <vue-seamless-scroll v-if="Object.keys(chainInfos).length != 0" :data="chainInfos[3]" :class-option="optionHover" class="seamless-warp">
                  <ul class="item">
                    <li v-for="(item,index) in chainInfos[3]" :key='index'>
                      <span class="title" v-text="item.title"></span><span class="value" v-text="item.value"></span>
                    </li>
                  </ul>
                </vue-seamless-scroll>
                <vue-seamless-scroll v-else :data="infoItem" :class-option="optionHover" class="seamless-warp">
                  <ul class="item">
                    <li v-for="(item,index) in infoItem" :key='index'>
                      <span class="title" v-text="item.title"></span><span class="value"> - 次</span>
                    </li>
                  </ul>
                </vue-seamless-scroll>
              </div>
            ...
            <div class="time_item">
              <div class="item_content" style="margin-top: -1%">
                <vue-seamless-scroll v-if="Object.keys(chainInfos).length != 0" :data="chainInfos[2]" :class-option="optionHover" class="seamless-warp">
                  <ul class="item">
                    <li v-for="(item,index) in chainInfos[2]" :key='index'>
                      <span class="title" v-text="item.title"></span><span class="value" v-text="item.value"></span>
                    </li>
                  </ul>
                </vue-seamless-scroll>
            ...
            <div class="time_item">
              ...
              <div class="item_content" style="bottom: 8%">
                <vue-seamless-scroll v-if="Object.keys(chainInfos).length != 0" :data="chainInfos[1]" :class-option="optionHover" class="seamless-warp">
                  <ul class="item">
                    <li v-for="(item,index) in chainInfos[1]" :key='index'>
                      <span class="title" v-text="item.title"></span><span class="value" v-text="item.value"></span>
                    </li>
                  </ul>
                </vue-seamless-scroll>
            ...
            <div class="time_item">
              <div class="item_content" style="margin-top: -1%">
                <vue-seamless-scroll v-if="Object.keys(chainInfos).length != 0" :data="chainInfos[0]" :class-option="optionHover" class="seamless-warp">
                  <ul class="item">
                    <li v-for="(item,index) in chainInfos[0]" :key='index'>
                      <span class="title" v-text="item.title"></span><span class="value" v-text="item.value"></span>
                    </li>
                  </ul>
                </vue-seamless-scroll>
    ...
    <!-- 人口、企业切换 -->
    <div class="tabCard">
      <div class="card" v-on:click="changeTabIndex(0)">
        <span>人口</span>
      </div>
      <div class="card" v-on:click="changeTabIndex(1)">
        <span>企业</span>
      </div>
      <div class="clickCard card" v-on:click="changeTabIndex(2)">
        <span>画像</span>
      </div>
    </div>
    ...
    <!-- 更新时间 -->
    <footerTime :isExplain="true" :screenId="13"/>
  </div>
</template>
...
<script>
  ...
  export default {
    ...
    data() {
      return {
        // 个人标签-身份证号
        inputIdCard: "110106196408100627",
        personInfo: {},
        // 默认图片
        defaultImg: noPerson,
    ...
    methods: {
      ...
      // 输入框 查找功能
      getAllInfo() {
        if (this.inputIdCard.length !== 18 && this.inputIdCard.length !== 15) {
      ...
      getTuoPu() {
        ...
        switch (this.healthCode) {
          ...
          case -2:
            ...
            break;
          case 0:
            color = "rgba(105,177,106, 0.8)"; // 绿色 #69b16a  105,177,106
            break;
          case 1:
            color = "rgba(242,194,70, 0.8)"; // 黄色#f2c246
            break;
          case 2:
            color = "rgba(234,49,34, 0.8)"; // 红色#ea3122
            break;
          default:
            color = "#0367A1";
        }
        data[0].itemStyle.normal.color = color;
      ...
      // 获取健康状态
      getHealthCode() {
        getHealthCode(this.query).then(res => {
          if (res.code == 200) {
            this.healthCode = res.data.healthCode;
          }
        })
      },
          ...
          if (res.code == 200) {
            setTimeout(() => {
              ...
              for (let i = 0; i < res.data.length; i++) {
                ...
                item[0].value = result.cntTotal + ' 次';
                item[1].value = result.cntSuccess + ' 次';
                // item[2].value = 10 + ' 次';
                // item[3].value = 20 + ' 次';
                this.chainInfos.push(item);
              }
            }, 1);
          }
        })
      ...
      changeTabIndex:function(data) {
        this.$emit("changeTabIndex", data)
      }
    }
  }
</script>
  ...
  .quality {
        ...
        .geren_logo {
          ...
          .logo_base {
            ...
            .logo_jkm_wu {
              width: 4.69rem;
              height: 4.25rem;
              background: url(../../assets/renkou-3/jkm_wu.png) no-repeat;
              background-size: 100% 100%;
              position: relative;
            }
            .logo_jkm_you {
              width: 4.69rem;
              height: 4.25rem;
              background: url(../../assets/renkou-3/jkm_you.png) no-repeat;
              background-size: 100% 100%;
              position: relative;
            }
            /*是否接种疫苗*/
            .logo_jzym_wu {
              width: 4.69rem;
              height: 4.25rem;
              background: url(../../assets/renkou-3/jzym_wu.png) no-repeat;
              background-size: 100% 100%;
              position: relative;
            }
            .logo_jzym_you {
              width: 4.69rem;
              height: 4.25rem;
              background: url(../../assets/renkou-3/jzym_you.png) no-repeat;
              background-size: 100% 100%;
              position: relative;
            }
            ...
            .logo_yxjz_wu {
              width: 4.69rem;
              height: 4.25rem;
              background: url(../../assets/renkou-3/yxjz_wu.png) no-repeat;
              background-size: 100% 100%;
              position: relative;
            }
            .logo_yxjz_you {
              width: 4.69rem;
              height: 4.25rem;
              background: url(../../assets/renkou-3/yxjz_you.png) no-repeat;
              background-size: 100% 100%;
              position: relative;
            }
            ...
            .logo_hjrk_you {
              width: 4.69rem;
              height: 4.25rem;
              background: url(../../assets/renkou-3/hjrk_you.png) no-repeat;
              background-size: 100% 100%;
              position: relative;
            }
            /*流动人口*/
    ...
    .bot {
      ...
      .left {
        ...
        margin-left: 0.06rem;
        margin-top: 0.25rem;
        background: url(../../assets/renkou-3/bottom.png) no-repeat;
