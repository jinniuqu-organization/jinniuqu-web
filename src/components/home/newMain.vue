<template>
  ...
  <div v-else class="newMain">
    ...
    <div class="center">
      ...
      <div class="map">
        <!-- 德胜街道 -->
        <div class="desheng_img" :class="activeRoad == 'desheng'?'desheng_img_active':null"
          @click="changeRoad('desheng')"></div>
        ...
        <!-- 西长安街道 -->
        <div class="xichangan_img" :class="activeRoad == 'xichangan'?'xichangan_img_active':null"
          @click="changeRoad('xichangan')"></div>
        ...
        <!-- 什刹海街道 -->
        <div class="shichahai_img" :class="activeRoad == 'shichahai'?'shichahai_img_active':null"
          @click="changeRoad('shichahai')"></div>
        ...
        <!-- 新街口街道 -->
        <div class="xinjiekou_img" :class="activeRoad == 'xinjiekou'?'xinjiekou_img_active':null"
          @click="changeRoad('xinjiekou')"></div>
        ...
        <!-- 展览路街道 -->
        <div class="zhanlanlu_img" :class="activeRoad == 'zhanlanlu'?'zhanlanlu_img_active':null"
          @click="changeRoad('zhanlanlu')"></div>
        ...
        <!-- 金融街道 -->
        <div class="jinrongjie_img" :class="activeRoad == 'jinrongjie'?'jinrongjie_img_active':null"
          @click="changeRoad('jinrongjie')"></div>
        ...
        <!-- 月坛街道 -->
        <div class="yuetanjie_img" :class="activeRoad == 'yuetanjie'?'yuetanjie_img_active':null"
          @click="changeRoad('yuetanjie')"></div>
        ...
        <!-- 广外街街道 -->
        <div class="guangwaijie_img" :class="activeRoad == 'guangwaijie'?'guangwaijie_img_active':null"
          @click="changeRoad('guangwaijie')"></div>
        ...
        <!-- 白纸坊街道 -->
        <div class="baizhifang_img" :class="activeRoad == 'baizhifang'?'baizhifang_img_active':null"
          @click="changeRoad('baizhifang')"></div>
        ...
        <!-- 椿树街道 -->
        <div class="chunshu_img" :class="activeRoad == 'chunshu'?'chunshu_img_active':null"
          @click="changeRoad('chunshu')"></div>
        ...
        <!-- 大栅栏街道 -->
        <div class="dashilan_img" :class="activeRoad == 'dashilan'?'dashilan_img_active':null"
          @click="changeRoad('dashilan')"></div>
        ...
        <!-- 牛街街道 -->
        <div class="niujie_img" :class="activeRoad == 'niujie'?'niujie_img_active':null" @click="changeRoad('niujie')">
        </div>
        ...
        <!-- 广内街街道 -->
        <div class="guangneijie_img" :class="activeRoad == 'guangneijie'?'guangneijie_img_active':null"
          @click="changeRoad('guangneijie')"></div>
        ...
        <!-- 陶然亭街道 -->
        <div class="taoranting_img" :class="activeRoad == 'taoranting'?'taoranting_img_active':null"
          @click="changeRoad('taoranting')"></div>
        ...
        <!-- 天桥街道 -->
        <div class="tianqiao_img" :class="activeRoad == 'tianqiao'?'tianqiao_img_active':null"
          @click="changeRoad('tianqiao')"></div>
      ...
      <div class="boxes">
        <div class="p_box1">
          ...
          <div class="floatTable">
            <el-table :data="floatData" size="small">
              <el-table-column type="index" label="排名" width="60">
                <template slot-scope="scope">
                  <img v-if="scope.$index + 1 == 1" src="../../assets/main/new/1.png" width="40" height="40"
                    class="head_pic" />
                  　　 <img v-if="scope.$index + 1 == 2" src="../../assets/main/new/2.png" width="40" height="40"
                    class="head_pic" />
                  <img v-if="scope.$index + 1 == 3" src="../../assets/main/new/3.png" width="40" height="40"
                    class="head_pic" />
                  <img v-if="scope.$index + 1 == 4" src="../../assets/main/new/4.png" width="40" height="40"
                    class="head_pic" />
                  <img v-if="scope.$index + 1 == 5" src="../../assets/main/new/5.png" width="40" height="40"
                    class="head_pic" />
                </template>
              </el-table-column>
              <el-table-column prop="floatReson" label="流动原因" align="center" show-overflow-tooltip>
              </el-table-column>
              <el-table-column prop="floatCnt" label="人口数量" align="center" show-overflow-tooltip>
              </el-table-column>
            </el-table>
          </div>
        </div>
    ...
    <div class="mask3" v-show="table1" @click.self="closeTable1">
      <div class="pop">
        ...
        <table>
          ...
          <tr class="tr3" :class="index%2==0?'double':'single'" v-for="(item, index) in personData" align="center"
            valign="middle">
            <td>{{item.areaName}}</td>
            <td>{{item.gross}}</td>
            <td>{{item.man}}</td>
    ...
    <div class="mask4" v-show="table2" @click.self="closeTable2">
      <div class="pop">
        ...
        <table>
          ...
          <tr class="tr3" :class="index%2==0?'double':'single'" v-for="(item, index) in companyData" align="center"
            valign="middle">
    ...
    <el-dialog :visible.sync="loginFlag" width="35%" top="10%" class="loginForm" :close-on-click-modal="false"
      ...
      <el-form :model="ruleForm" status-icon ref="ruleForm" label-width="100px" class="demo-ruleForm">
        ...
        <el-form-item style="margin-left: -3%">
          <el-button style="background-color: #22ABFF" @click="resetForm('ruleForm')">重&nbsp;&nbsp;&nbsp;&nbsp;置
          </el-button>
          <el-button type="primary" style="margin-left: 3.1rem; background-color: #F8A717"
