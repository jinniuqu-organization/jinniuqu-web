  ...
  <div class="collection">
    ...
    <div class="box middle">
      ...
      <div class="collectData">
        <el-table :data="collectData" style="width: 96%; margin-left: 2%" max-height="100%"
          :row-class-name="collectRowClassName" @row-click="changeIndex">
          <el-table-column prop="tableType" label="信息资源分类" align="center" width="160">
          </el-table-column>
          <el-table-column prop="departName" label="数据来源" align="left" show-overflow-tooltip width="160">
          </el-table-column>
          <el-table-column prop="tableNote" label="信息资源" align="left" show-overflow-tooltip width="180">
          </el-table-column>
          <el-table-column prop="updateCycle" label="更新周期" align="center">
          </el-table-column>
          <el-table-column prop="dataRange" label="数据范围" align="center">
          </el-table-column>
          <el-table-column prop="dataCount" label="数据量" align="left">
          </el-table-column>
        </el-table>
      </div>
    </div>
    ...
    <div class="box left">
      ...
      <div class="rb"></div>
      <div class="dc_line">
        <el-carousel indicator-position="none" height="100%" :autoplay="false" direction="vertical" :interval="7000"
          ref="first">
    ...
    <el-dialog :visible.sync="docInfoFlag" top="12.3%" show-close class="docInfo" :title="tableName"
      :close-on-click-modal="false">
      <el-table :data="docInfos" max-height="480" style="width: 100%">
        <el-table-column type="index" label="序号" align="center" width="60">
        </el-table-column>
        <el-table-column prop="column" label="列" align="center" width="180">
        </el-table-column>
        <el-table-column prop="columnNote" label="列注释" align="center">
        </el-table-column>
        <el-table-column prop="codeState" align="center" width="180" label="字典状态">
        </el-table-column>
      </el-table>
    </el-dialog>
    ...
    data() {
      return {
        ...
        lineColor: ["#015bff", "#ffab05", "#09ce0b", "#015bff", "#ffab05", "#09ce0b", "#015bff", "#ffab05", "#09ce0b",
          "#015bff", "#ffab05", "#015bff", "#ffab05", "#09ce0b", "#015bff", "#ffab05", "#09ce0b", "#015bff",
          "#ffab05", "#09ce0b", "#015bff", "#ffab05"
        ],
        //折线下面积渐变颜色
        linearColor: [{
          "top": "#03367b",
        ...
        docItemIndex: 0,
        //左侧数据数组
        lineChart: ["市民政局数据流", "市质监数据流", "市资源中心数据流", "卫健委数据流", "西长安街数据流", "区科信局数据流", "区城管执法监察局数据流", "市流管办数据流", "什刹海数据流",
          "市残联数据流", "市工商局数据流"
        ],
        //获取采集统计数据(各部门)
        collectionInfo: [],
